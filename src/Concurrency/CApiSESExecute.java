...
public class CApiSESExecute {
	...
	try {
		...
		service.scheduleWithFixedDelay(task3, 0, 10, TimeUnit.SECONDS);
		service.scheduleAtFixedRate(task4, 0, 10, TimeUnit.SECONDS);//first value is initial and last is every unit
